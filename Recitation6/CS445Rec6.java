// CS 0445 Spring 2026
// Test Program for Recitation 6 Exercise
// After you get the program to compile and run, compare your output to that
// in file:
// Rec6Out.txt
// Note: This program is identical to that of Recitation Exercise 4, except
// for the name of the list class - here it is DLListRec.
...
{	
	public static void main(String [] args)
	{
		...
		DLListRec<String> L1 = new DLListRec<String>();
