...
// CS 0445 Spring 2026
// Modification of author's HashedDictionary as specified in Recitation Exercise 12.
// For details see Recitation Exercise 12 and more comments below.  Search for
// CS 0445
// to find the comments.  There are several locations so be sure to search for all
// occurrences.
...
public class HashedDictionary<K, V> implements DictionaryInterface<K, V>
{
   // The dictionary:
	...
	// CS 0445 Spring 2025
	// Instance variable added to keep track of number of probes
	private int probes;
...
//    hashIndex = quadraticProbe(hashIndex, key);
   ...
   // Precondition: checkInitialization has been called.
	...
	{
	  // CS 0445 Spring 2026
	  // Method linearProbe does the iterating within the hash table and for each
	  // probe we increment the value of the probes variable.  Thus when the method
	  // finishes we know how many probes were needed.  Note that a "probe" here is
	  // a check of the value of the hash table at a location.
	  probes = 0;
      boolean found = false;
      int availableIndex = -1; // Index of first available location (from which an entry was removed)
      
      probes++;  // CS 0445 -- This increment is for the test in the loop header
      while ( !found && (hashTable[index] != null) )
      {
         // CS 0445 An extra probe is being done here but we won't count it.  We will
         // consider just one probe per iteration of the loop.
         ...
         // CS 0445 Spring 2025 -- This increment is for the test in the next 
         // iteration of the loop header
         probes++;
      } // end while
   ...
   private void checkSize(int size)
   {
	...
	// CS 0445 Spring 2026
	// The two methods below are added for Rec 12.  These allow the specs of the
	// load factor to be changed dynamically and for the probes value to be returned
	// to the user.
